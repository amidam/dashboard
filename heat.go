...
var (
	...
	weekDays = [...]string{"شنبه", "یکشنبه", "دوشنبه", "سه شنبه", "چهارشنبه", "پنجشنبه", "جمعه"}
...
func heatMapBase(w http.ResponseWriter, _ *http.Request) {
	hm := charts.NewHeatMap()
	hm.SetGlobalOptions(
		charts.WithTitleOpts(opts.Title{
			Title: "نمودار حرارتی",
			Subtitle: "این داده ها بر پایه ترافیک انسانی در شهر زنجان تنظیم شده اند. شایان گفتن است این داده ها واقعی نیستند",
		}),
